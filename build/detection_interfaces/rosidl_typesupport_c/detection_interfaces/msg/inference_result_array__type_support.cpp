...
static const _InferenceResultArray_type_support_symbol_names_t _InferenceResultArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, detection_interfaces, msg, InferenceResultArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, detection_interfaces, msg, InferenceResultArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, detection_interfaces, msg, InferenceResultArray)() {
  return &::detection_interfaces::msg::rosidl_typesupport_c::InferenceResultArray_message_type_support_handle;
}
