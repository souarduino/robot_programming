...
#include "detection_interfaces/msg/detail/inference_result__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const detection_interfaces::msg::InferenceResult & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  detection_interfaces::msg::InferenceResult & ros_message)
{
  // Member: class_name
  cdr >> ros_message.class_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = detection_interfaces::msg::InferenceResult;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const detection_interfaces::msg::InferenceResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<detection_interfaces::msg::InferenceResult *>(
    untyped_ros_message);
...
{
  return &detection_interfaces::msg::typesupport_fastrtps_cpp::_InferenceResult__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, detection_interfaces, msg, InferenceResult)() {
  return &detection_interfaces::msg::typesupport_fastrtps_cpp::_InferenceResult__handle;
}
